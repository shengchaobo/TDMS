...
<meta http-equiv="description" content="This is my page">
	...
	<script type="text/javascript" src="jquery-easyui/jquery.easyui-1.7.2.min.js"></script>
	<script type="text/javascript" src="jquery-easyui/dialog_bug.js"></script> 
	<script type="text/javascript" src="jquery-easyui/locale/easyui-lang-zh_CN.js"></script>
</head>
<body style="overflow-y:scroll">
	<table id="dg" title="待审核数据域审核未通过数据" class="easyui-datagrid" style="width:100%px;height:250px" url="table5/verifingData"
		...
		<thead>
			<tr>
				...
				<th field="state" width="5%" fit="true">状态</th>
	...
	<table id="dg2" title="审核通过数据" class="easyui-datagrid" style="width:100%px;height:250px" url="table5/verifiedData"
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post">
			<tr>
				<td>
					<div class="fitem">
						<label>课程名称：</label> <input id="csBaseLibraries.csName" name="csBaseLibraries.csName"
							class="easyui-validatebox" required="true">
					</div>
				</td>
				<td>
					<div class="fitem">
						<label>课程编号：</label> <input id="csBaseLibraries.csId" name="csBaseLibraries.csId"
							class="easyui-validatebox" required="true">
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div class="fitem">
						<label>开课单位：</label> <input class='easyui-combogrid' id="csBaseLibraries.csUnit" name="csBaseLibraries.csUnit">
					</div>
				</td>
				<td>
					<div class="fitem">
						<label>所属教研室：</label> <input class='easyui-combogrid' id="csBaseLibraries.fromTeaResOffice" name="csBaseLibraries.fromTeaResOffice">
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div class="fitem">
						<label>课程类别：</label> <input class='easyui-combogrid' id="csBaseLibraries.csType" name="csBaseLibraries.csType">
					</div>
				</td>
				<td>
					<div class="fitem">
						<label>课程性质：</label> <input class='easyui-combogrid' id="csBaseLibraries.csNature" name="csBaseLibraries.csNature">
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div class="fitem">
						<label>状&nbsp;&nbsp;&nbsp;&nbsp;态：</label> <input class='easyui-combogrid' id="csBaseLibraries.state" name="csBaseLibraries.state"
							class="easyui-validatebox" validType="email">
					</div>
				</td>
				<td>
					<div class="fitem">
						<label>公选课类别：</label> <input class='easyui-combogrid' id="csBaseLibraries.pubCsType" name="csBaseLibraries.pubCsType">
					</div>
				</td>
			</tr>
			<tr>
			<div class="fitem">
				<td style="valign:left"><label>备&nbsp;&nbsp;&nbsp;&nbsp;注：</label><textarea id="csBaseLibraries.note" name="csBaseLibraries.note" style="resize:none" cols="50" rows="10"></textarea></td>
			</div>
			</tr>
		</form>
		</table>
