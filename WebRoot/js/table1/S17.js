...
$(function(){  
				...
				var rows = [
				        ...
				        { "name": "      境外", "group": "校友会（个）", "value": "", "field": "outlandNum","editor":  false }
                   ];
				...
				$('#edit').propertygrid({
				  ...
				  $.ajax( {
							...
							url: 'pages/S17/loadInfo?selectYear='+selectYear,
				    		async : false,
				    		dataType : "json",
				 ...
				 $("#cbYearContrast").combobox({  
		       	...
		       	function reloadgrid (year,flag)  { 
       				  $.ajax( {
				    		type : "POST",
				    		contentType: "application/json;utf-8",
							url: 'pages/S17/loadInfo?selectYear='+year,
				    		async : false,
				    		dataType : "json",
				    		success : function(json) {
			       					if(typeof(json.data)!="undefined"){
			   ...
			   $("#save").click(function(){
				    ...
				    var year = $("#cbYearContrast").combobox('getValue'); 
     				$.ajax( {
					    		type : "POST",
					    		contentType: "application/json;utf-8",
								url: 'pages/S17/save?data='+data+'&selectYear='+year+'&fields='+f,
					    		async : false,
					    		dataType : "json",
					    		success : function(json) {
			   ...
			   $("#export").click(function(){
			        var tableName = encodeURI('表1-7校友会');
			        var year = $("#cbYearContrast").combobox('getValue'); 
				    $('#exportForm').form('submit', {
				    	data : $('#exportForm').serialize(),
					    url : "pages/S17/dataExport?excelName="+tableName+'&selectYear='+year,
					    onSubmit : function() {
