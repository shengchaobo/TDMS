...
$(function(){  
				...
				$('#edit').propertygrid({
				  ...
				  $.ajax( {
							...
							url: 'pages/S18/loadInfo?selectYear='+selectYear,
				    		async : false,
				    		dataType : "json",
				 ...
				 $("#cbYearContrast").combobox({  
		       	...
		       	function reloadgrid (year,flag)  { 
       				  $.ajax( {
				    		type : "POST",
				    		contentType: "application/json;utf-8",
							url: 'pages/S18/loadInfo?selectYear='+year,
				    		async : false,
				    		dataType : "json",
				    		success : function(json) {
			       					if(typeof(json.data)!="undefined"){
			   ...
			   $("#save").click(function(){
				    ...
				    var year = $("#cbYearContrast").combobox('getValue'); 
     				$.ajax( {
					    		type : "POST",
					    		contentType: "application/json;utf-8",
								url: 'pages/S18/save?data='+data+'&selectYear='+year+'&fields='+f,
					    		async : false,
					    		dataType : "json",
					    		success : function(json) {
			   ...
			   $("#export").click(function(){
			        var tableName = encodeURI('表S-1-8签订合作协议机构的协议个数');
			        var year = $("#cbYearContrast").combobox('getValue'); 
				    $('#exportForm').form('submit', {
				    	data : $('#exportForm').serialize(),
					    url : "pages/S18/dataExport?excelName="+tableName+'&selectYear='+year,
					    onSubmit : function() {
