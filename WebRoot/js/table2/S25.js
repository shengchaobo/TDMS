	...
	$(function() {
		...
		$('#showData').datagrid( {
			title : '本科实验、实习、实训场所',  //可变内容在具体页面定义
			url: 'pages/S25/loadInfo',
			iconCls : 'icon-ok',
			width : '100%',
			//height: '100%',
	   ...
	   //导出
	        ...
	        var tableName = encodeURI('S-2-5本科实验、实习、实训场所');
	        var year = $("#cbYearContrast").combobox('getValue'); 
		    $('#exportForm').form('submit', {
		    	data : $('#exportForm').serialize(),
			    url : "pages/S25/dataExport?excelName="+tableName+'&selectYear='+year,
			    onSubmit : function() {
