	...
	$(function() {
		...
		$('#showData').datagrid( {
			title : '培养计划学时学分结构分析',  //可变内容在具体页面定义
			url: 'pages/A323/loadInfo',
			iconCls : 'icon-ok',
			width : '100%',
			//height: '100%',
	   ...
	   $("#export").click(function(){
	        var tableName = encodeURI('A-3-2-3培养计划学时学分结构分析');
	        var year = $("#cbYearContrast").combobox('getValue'); 
		    $('#exportForm').form('submit', {
		    	data : $('#exportForm').serialize(),
			    url : "pages/A323/dataExport?excelName="+tableName+'&selectYear='+year,
			    onSubmit : function() {
