	$(function(){  
				...
				var rows = [
					        ...
					        { "name": "专任教师人数", "group": "6.任职类别", "value": "", "field": "fullTimeTeaNum","editor":  false },
					        { "name": "专任教师比例", "group": "6.任职类别", "value": "", "field": "fullTimeRatio","editor":  false },
					        { "name": "教学管理人员人数", "group": "6.任职类别", "value": "",  "field": "teaManageNum","editor":  false},
					        { "name": "教学管理人员比例",  "group": "6.任职类别", "value": "", "field": "teaManageRatio", "editor":  false},
					        { "name": "学生管理人员人数", "group": "6.任职类别", "value": "", "field": "stuManageNum","editor":  false },
					        { "name": "学生管理人员比例", "group": "6.任职类别", "value": "", "field": "stuManageRatio","editor":  false },
					        { "name": "教学质量监控人员人数", "group": "6.任职类别", "value": "",  "field": "teaMonitorNum","editor":  false},
					        { "name": "教学质量监控人员比例", "group": "6.任职类别", "value": "",  "field": "teaMonitorRatio","editor":  false},
				...
				$('#edit').propertygrid({
				  ...
				  $.ajax( {
							...
							url: 'pages/A411/loadInfo?selectYear='+selectYear,
				    		async : false,
				    		dataType : "json",
				 ...
				 $("#cbYearContrast").combobox({  
		       	...
		       	function reloadgrid (year,flag)  { 
       				  $.ajax( {
				    		type : "POST",
				    		contentType: "application/json;utf-8",
							url: 'pages/A411/loadInfo?selectYear='+year,
				    		async : false,
				    		dataType : "json",
				    		success : function(json) {
				    			if(typeof(json.data)!="undefined"){
