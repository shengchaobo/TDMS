	$(function(){  
				...
				$('#edit').propertygrid({
				  ...
				  $.ajax( {
							...
							url: 'pages/A441/loadInfo?selectYear='+selectYear,
				    		async : false,
				    		dataType : "json",
				 ...
				 $("#cbYearContrast").combobox({  
		       	...
		       	function reloadgrid (year,flag)  { 
       				  $.ajax( {
				    		type : "POST",
				    		contentType: "application/json;utf-8",
							url: 'pages/A441/loadInfo?selectYear='+year,
				    		async : false,
				    		dataType : "json",
				    		success : function(json) {
				    			if(typeof(json.data)!="undefined"){
			   ...
			   $("#export").click(function(){
			        var tableName = encodeURI('A-4-4-1专业带头人结构分析');
			        var year = $("#cbYearContrast").combobox('getValue'); 
				    $('#exportForm').form('submit', {
				    	data : $('#exportForm').serialize(),
					    url : "pages/A441/dataExport?excelName="+tableName+'&selectYear='+year,
					    onSubmit : function() {
