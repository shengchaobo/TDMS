	...
	$(function() {
		...
		$('#showData').datagrid( {
			title : '教师所获荣誉统计(按教学单位统计荣誉数)',  //可变内容在具体页面定义
			url: 'pages/S462/loadInfo',
			iconCls : 'icon-ok',
			width : '100%',
			//height: '100%',
	   ...
	   $("#export").click(function(){
	        var tableName = encodeURI('S-4-6-2教师所获荣誉统计');
	        var year = $("#cbYearContrast").combobox('getValue'); 
		    $('#exportForm').form('submit', {
		    	data : $('#exportForm').serialize(),
			    url : "pages/S462/dataExport?excelName="+tableName+'&selectYear='+year,
			    onSubmit : function() {
