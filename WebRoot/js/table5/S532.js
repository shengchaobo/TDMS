	...
	$(function() {
		...
		$('#showData').datagrid( {
			title : '实验教学示范中心统计',  //可变内容在具体页面定义
			url: 'pages/S532/loadInfo',
			iconCls : 'icon-ok',
			width : '100%',
			//height: '100%',
	   ...
	   $("#export").click(function(){
	        var tableName = encodeURI('S-5-3-2实验教学示范中心统计');
	        var year = $("#cbYearContrast").combobox('getValue'); 
		    $('#exportForm').form('submit', {
		    	data : $('#exportForm').serialize(),
			    url : "pages/S532/dataExport?excelName="+tableName+'&selectYear='+year,
			    onSubmit : function() {
