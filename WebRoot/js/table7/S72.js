	...
	$(function() {
		...
		$('#showData').datagrid( {
			title : '教育教学研究与改革项目',  //可变内容在具体页面定义
			url: 'pages/S72/loadInfo',
			iconCls : 'icon-ok',
			width : '100%',
			//height: '100%',
	   ...
	   $("#export").click(function(){
	        var tableName = encodeURI('S-7-2教育教学研究与改革项目统计');
	        var year = $("#cbYearContrast").combobox('getValue'); 
		    $('#exportForm').form('submit', {
		    	data : $('#exportForm').serialize(),
			    url : "pages/S72/dataExport?excelName="+tableName+'&selectYear='+year,
			    onSubmit : function() {
