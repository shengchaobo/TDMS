...
<meta http-equiv="description" content="This is my page">
  ...
  function passCheck(seqNumber){
		    ...
		    $.ajax({
				    type:"POST", 
				    url: "pages/DocAndGraSta/updateCheck?seqNum=" + seqNumber +"&checkNum=" + checkNum, 
			   		async : "true",
			   		dataType : "text",
  ...
  function checkAll(){
		    ...
		    $.ajax({
				    type:"POST", 
				    url: "pages/DocAndGraSta/checkAll", 
			   		async : "true",
			   		dataType : "text",
				    success:function(result){  
				         result = eval("(" + result + ")");						    	 
...
<body style="height: 100%'">
  ...
  <div id="toolbar"  style="float: right;">
		...
		<table  id="checkPassData"  class="easyui-datagrid"  url="pages/DocAndGraSta/auditingData?checkNum=<%=request.getAttribute("PASSCHECK")%>&checkFlag=1"   style="height: auto"  >
		<thead data-options="frozen:true">
			<tr>			
			...
			<table>
				...
				<tr>
					<td>
						<div class="fitem">
							<label>被审核表ID：</label> 
								<input type="text" name="checkInfo.tableID" id="tableName"   value="T312"
								readonly="readonly"  style="width: 150px;color: grey"/>
							</div>
					</td>
				</tr>
