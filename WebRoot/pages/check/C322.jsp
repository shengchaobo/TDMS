...
<body style="height: 100%" >  
	<table  id="checkData"  class="easyui-datagrid"  url="pages/UndergraMajorInfoTea/auditingData?checkNum=<%=request.getAttribute("WAITCHECK") %>"    style="height: auto"  >
		...
		<table  id="checkPassData"  class="easyui-datagrid"  url="pages/UndergraMajorInfoTea/auditingData?checkNum=<%=request.getAttribute("PASSCHECK")%>&checkFlag=1"    style="height: auto"  >
		<thead data-options="frozen:true">
			<tr>			
