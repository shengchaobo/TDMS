...
<body style="height: 100%'">
	...
	<table  id="checkPassData"  class="easyui-datagrid"  url="pages/JuniorMajInfo/auditingData?checkNum=<%=request.getAttribute("PASSCHECK")%>&checkFlag=1"   style="height: auto"  >
		<thead data-options="frozen:true">
			<tr>			
