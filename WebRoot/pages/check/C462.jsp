...
<body style="height: 100%" >  
	...
	<table  id="checkPassData"  class="easyui-datagrid"  url="pages/T461/loadHonorInfo?checkNum=<%=request.getAttribute("PASSCHECK") %>&param=2&checkFlag=0"    style="height: auto"  >
		<thead data-options="frozen:true">
			<tr>			
