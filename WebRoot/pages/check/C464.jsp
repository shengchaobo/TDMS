...
<body style="height: 100%" >  
	<table  id="checkData"  class="easyui-datagrid"  url="pages/T461/loadHonorInfo?checkNum=<%=request.getAttribute("WAITCHECK") %>&param=4"    style="height: auto"  >
	...
	<table  id="checkPassData"  class="easyui-datagrid"  url="pages/T461/loadHonorInfo?checkNum=<%=request.getAttribute("PASSCHECK") %>&param=4&checkFlag=1"    style="height: auto"  >
		<thead data-options="frozen:true">
			<tr>			
  ...
  <div id="toolbar"  style="float: right;">
			<a href="javascript:checkAll('4')" class="easyui-linkbutton" iconCls="icon-download" plain="true"  >
					一键全审核通过
			</a>
	</div>
			...
			<table>			
				...
				<tr>
					<td>
						<div class="fitem">
							<label>被审核表ID：</label> 
								<input type="text" name="checkInfo.tableID" id="tableName"   value="T464"
								readonly="readonly"  style="width: 150px;color: grey"/>
							</div>
					</td>
				</tr>
