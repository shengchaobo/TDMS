...
<body style="height: 100%" >  
	...
	<table  id="checkPassData"  class="easyui-datagrid"  url="pages/T461/loadHonorInfo?checkNum=<%=request.getAttribute("PASSCHECK") %>&param=6&checkFlag=1"    style="height: auto"  >
		<thead data-options="frozen:true">
			<tr>			
