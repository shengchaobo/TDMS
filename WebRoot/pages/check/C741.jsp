...
<meta http-equiv="description" content="This is my page">
  ...
  function passCheck(seqNumber){
		    ...
		    $.ajax({
				    type:"POST", 
				    url: "pages/T741/updateCheck?seqNum=" + seqNumber +"&checkNum=" + checkNum, 
			   		async : "true",
			   		dataType : "text",
...
<body style="height: 100%'">
	<table  id="checkData"  class="easyui-datagrid"  url="pages/T741/auditingData?checkNum=<%=request.getAttribute("WAITCHECK") %>"   style="height: auto"  >
	...
	<table  id="checkPassData"  class="easyui-datagrid"  url="pages/T741/auditingData?checkNum=<%=request.getAttribute("PASSCHECK") %>&checkFlag=0"    style="height: auto"  >
		<thead data-options="frozen:true">
			<tr>			
				<th  data-options="field:'check',align:'center'"   formatter="rowformater">审核操作</th>
		  </tr>
			...
			<table>			
				...
				<tr>
					<td>
						<div class="fitem">
							<label>被审核表ID：</label> 
								<input type="text" name="checkInfo.tableID" id="tableName"   value="T741"
								readonly="readonly"  style="width: 150px;color: grey"/>
							</div>
					</td>
				</tr>
