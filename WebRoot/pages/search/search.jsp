...
<body style="overflow-y:scroll">
	<div>
		<input id="UnitID" name="undergraCSBaseTea.UnitID" 
			class='easyui-combobox' data-options="valueField:'CNTableName',textField:'CNTableName',url:'pages/diDataSearch/loadTableName',listHeight:'auto',editable:false,
			onSelect:function(){
							 	loadDic() ;
							 }">
		<span id="DiSearchDataSpanSpan"></span>
	</div>
	<div id="toolbar2">
	...
	<script type="text/javascript">
	    ...
	    function loadDictionary(){
	    	...
	    	$.ajax({ 
	    		type: "POST", 
	    		url: "pages/diDataSearch/loadDic", 
	    		async:"false",
	    		dataType: "text",
