...
<html>
	<head>
		...
		<script type="text/javascript" src="jquery-easyui/dialog_bug.js"></script>
		<script type="text/javascript" src="js/system/AwardLevelManager.js"></script>
	...
	<table id="levelManager" class="easyui-datagrid"  style="height: auto;"  >
		<thead>
			<tr>
				...
				<th field="indexId">荣誉奖项代码</th>
				<th field="awardLevel">荣誉奖项级别</th>
					...
					<tr>
						...
						<td>
							<div class="fitem">
								...
								<input id="AwardLevel" type="text" name="level_bean.awardLevel"
									class="easyui-validatebox">
