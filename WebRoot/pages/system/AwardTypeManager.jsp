...
<html>
	<head>
		...
		<script type="text/javascript" src="jquery-easyui/dialog_bug.js"></script>
		<script type="text/javascript" src="js/system/AwardTypeManager.js"></script>
	...
	<table id="typeManager" class="easyui-datagrid"  style="height: auto;"  >
		<thead>
			<tr>
				...
				<th field="indexId">荣誉代码</th>
				<th field="awardType">荣誉类型</th>
					...
					<tr>
						...
						<td>
							<div class="fitem">
								...
								<input id="AwardType" type="text" name="type_bean.awardType"
									class="easyui-validatebox">
