...
<html>
	<head>
		...
		<script type="text/javascript" src="jquery-easyui/dialog_bug.js"></script>
		<script type="text/javascript" src="js/system/TutorTypeManager.js"></script>
	...
	<table id="typeManager" class="easyui-datagrid"  style="height: auto;"  >
		<thead>
			<tr>
				...
				<th field="indexId">导师代码</th>
				<th field="tutorType">导师类别</th>
	...
	<div id="toolbar" style="height:auto">
		<div style="float: left;height: 24">
			<a href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-add" plain="true" onclick="newType()">添加导师类别</a>
			<a href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-edit" plain="true" onclick="editType()">编辑导师类别</a> 
			<a href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-remove" plain="true" onclick="deleteByIds()">删除导师类别</a>
		</div>
					...
					<tr>
						...
						<td>
							<div class="fitem">
								...
								<input id="TutorType" type="text" name="type_bean.tutorType"
									class="easyui-validatebox">
