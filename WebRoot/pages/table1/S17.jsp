...
<body style="overflow-y:scroll">
	...
	<tbody >
	        ...
	        <tr>
	          <th  rowspan = 3  align="left" style="width:40px;background-color:white ">校友会（个）</th>
	          <th  align="left" style="width:60px;background-color:white ">总数</th>
	          <th style="background-color:white">
	             <div>
	          		<span id="SumSchFriNumSpan"></span>
	          	</div>
	          </th>
	        </tr>
	        <tr>
	          <th align="left" style="width:60px;background-color:white ">其中：境内</th>
	          <th style="background-color:white">
	         	<div>
	         		 <span id="InlandNumSpan"></span>
	         	</div>	 
	          </th>
	        </tr>
	        <tr>
	          <th align="left" style="width:60px;background-color:white ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;境外</th>
	          <th style="background-color:white">
	          	<div>
	          		<span id="OutlandNumSpan"></span>
	            </div>
	          </th>
	        </tr>
	...
	<div id="toolbar" style="height:auto">
		...
		<form  id="exportForm"  method="post" style="float: right;">
				<select class="easyui-combobox" id="cbYearContrast" editable="false" name="selectYear" panelHeight="auto" style="width:80px; padding-top:5px; margin-top:10px;"></select>
	...
	function loadAuotCityList() {
		...
		$.ajax( {
			type : "POST", //post请求
			url : "pages/S17/auditingData", //请求action的URL
			dataType : "json",//返回类型
