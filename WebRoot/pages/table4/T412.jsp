...
<body style="height: 100%'" >
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T412/dataExport?excelName=<%=URLEncoder.encode("表4-1-2各专业专任教师队伍名单.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 
	...
	<div id="dlg" class="easyui-dialog"
		...
		buttons="#dlg-buttons">
		<h3 class="ftitle" id="title1">专任教师模板导入</h3>
