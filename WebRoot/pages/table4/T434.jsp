...
<body>
	<table id="showData"  title="教学质量监控人员" class="easyui-datagrid"  url ="pages/T411/loadT434"  style="height: auto;">
    ...
    <div style="float: left;">
			<a href='pages/T411/dataExport1?excelName=<%=URLEncoder.encode("表4-3-4教学质量监控人员（评估中心）","UTF-8")%>&param=4'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 
		</div>
