...
<body style="height: 100%'"  onload="myMarquee('T441','<%=request.getAttribute("CHECKTYPE") %>')">
  <div  id="floatDiv">
  ...
  <br/> 
	<table  id="unverfiedData"  class="easyui-datagrid"  url="pages/T441/loadLeaderInfo?checkNum=<%=request.getAttribute("NOCHECK") %>"  style="height: auto"  >
	...
	<table id="verfiedData"  class="easyui-datagrid"  url="pages/T441/loadLeaderInfo?checkNum=<%=request.getAttribute("PASS") %>"  style="height: auto;" >
		<thead data-options="frozen:true">
			<tr>			
				<th data-options="field:'ck',checkbox:true">选取</th>
				<th  data-options="field:'seqNumber'" >编号</th>
	...
	<div id="toolbar2" style="float: right;">
			<form action='pages/T441/dataExport?excelName=<%=URLEncoder.encode("表4-4-1专业带头人（教学单位-教务处）","UTF-8")%>'   method="post"  id="exportForm" enctype="multipart/form-data"  style="float: right;">
	...
	<div id="dlg" class="easyui-dialog"
		...
		buttons="#dlg-buttons">
		<h3 class="title1">专业带头人模板导入</h3>
		<div class="fitem" id="item1">
		  <form method="post"  id="batchForm" enctype="multipart/form-data">
		  		<select class="easyui-combobox"  id="cbYearContrast" name="selectYear"  editable=false></select>
				<input type="file" name="uploadFile" id="fileToUpload" class="easyui-validatebox" size="48" style="height: 24px;" required="true" />
				<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-save" onclick="batchImport()">模板导入</a>
				<a href='pages/T441/downloadModel?saveFile=<%=URLEncoder.encode("表4-4-1专业带头人","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download">模板下载</a>
			</form>
		</div>		
		<hr></hr>	
	   <h3 class="title1">专业带头人逐条导入</h3>
	   <form id="addForm" method="post">
		<table><!--
			...
			<tr>
				...
				<input type="hidden"  name="T441_bean.teaUnitID"  id="teaUnitID" >
				<div class="fitem">
				<label>教工号：</label> 
