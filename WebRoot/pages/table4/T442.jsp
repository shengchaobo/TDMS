...
<body style="height: 100%'"  onload="myMarquee('T442','<%=request.getAttribute("CHECKTYPE") %>')">
  <div  id="floatDiv">
  ...
  <br/> 
	<table  id="unverfiedData"  class="easyui-datagrid"  url="pages/T442/loadTutorInfo?checkNum=<%=request.getAttribute("NOCHECK") %>"  style="height: auto"  >
	...
	<table id="verfiedData"  class="easyui-datagrid"  url="pages/T442/loadTutorInfo?checkNum=<%=request.getAttribute("PASS") %>"  style="height: auto;" >
		<thead data-options="frozen:true">
			<tr>			
				<th data-options="field:'ck',checkbox:true">选取</th>
				<th  data-options="field:'seqNumber'" >编号</th>
	...
	<div id="toolbar2" style="float: right;">
		<form action='pages/T442/dataExport?excelName=<%=URLEncoder.encode("表4-4-2研究生导师情况（研究生院）","UTF-8")%>'   method="post"  id="exportForm" enctype="multipart/form-data"  style="float: right;">
