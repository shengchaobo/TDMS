...
<body style="height: 100%'"  onload="myMarquee('T444','<%=request.getAttribute("CHECKTYPE") %>')">
  <div  id="floatDiv">
  ...
  <br/> 
	<table  id="unverfiedData"  class="easyui-datagrid"  url="pages/T444/loadTeamInfo?checkNum=<%=request.getAttribute("NOCHECK") %>"    style="height: auto"  >
	...
	<table id="verfiedData"  class="easyui-datagrid"  url="pages/T444/loadTeamInfo?checkNum=<%=request.getAttribute("PASS") %>"  style="height: auto;" >
		<thead data-options="frozen:true">
			<tr>			
				<th data-options="field:'ck',checkbox:true">选取</th>
				<th  data-options="field:'seqNumber'" >编号</th>
	...
	<div id="toolbar2">
		<form action='pages/T444/dataExport?excelName=<%=URLEncoder.encode("表4-4-4高层次研究团队（科研处）","UTF-8")%>'   method="post"  id="exportForm" enctype="multipart/form-data"  style="float: right;">
