...
<body style="height: 100%'" >
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T452/dataExport?excelName=<%=URLEncoder.encode("表4-5-2教师培训进修情况（教学单位-人事处）.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 		
