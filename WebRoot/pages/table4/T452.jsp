...
<body style="height: 100%'"  onload="myMarquee('T452','<%=request.getAttribute("CHECKTYPE") %>')">
  <div  id="floatDiv">
   ...
   <br/>
	<table  id="unverfiedData"  class="easyui-datagrid"  url="pages/T452/loadTrainInfo?checkNum=<%=request.getAttribute("NOCHECK") %>" style="height: auto"  >
	...
	<table id="verfiedData"  class="easyui-datagrid"  url="pages/T452/loadTrainInfo?checkNum=<%=request.getAttribute("PASS") %>" style="height: auto;" >
		<thead data-options="frozen:true">
			<tr>			
				<th data-options="field:'ck',checkbox:true">选取</th>
				<th  data-options="field:'seqNumber'" >编号</th>
	...
	<div id="toolbar2">
				<form action='pages/T452/dataExport?excelName=<%=URLEncoder.encode("表4-5-2教师培训进修情况（教学单位-人事处）","UTF-8")%>'   method="post"  id="exportForm" enctype="multipart/form-data"  style="float: right;">
		...
		<table><!--
			...
			<tr>
			  ...
			  <input type="hidden" name="T452_bean.seqNumber" id="seqNumber"/>
				...
				<input type="hidden"  name="T452_bean.unitId"  id="unitId" >
				<div class="fitem">
				<label>进修教师教工号：</label> 
