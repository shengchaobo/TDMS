...
<body style="height: 100%'" >
	...
	<div id="toolbar" style="height:auto">
		...
		<form method="post"  id="searchForm"   style="float: right;height: 24px;"  >
			...
			结束日期: <input id="endsTime"  name="endsTime" class="easyui-datebox" style="width:80px"/>
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T452/dataExport?excelName=<%=URLEncoder.encode("表4-5-2教师培训进修情况.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 		
	...
	<div id="dlg" class="easyui-dialog"
		...
		buttons="#dlg-buttons">
		<h3 class="ftitle" id="title1">教师培训进修情况模板导入</h3>
	   ...
	   <h3 class="ftitle">教师培训进修情况逐条导入</h3>
