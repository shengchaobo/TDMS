...
<body style="height: 100%'" >
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T453/dataExport?excelName=<%=URLEncoder.encode("表4-5-3教师交流情况.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 		
	...
	<div id="dlg" class="easyui-dialog"
		...
		buttons="#dlg-buttons">
		<h3 class="ftitle" id="title1">教师交流情况模板导入</h3>
