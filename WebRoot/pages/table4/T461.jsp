...
<body style="height: 100%'" >
	<table  id="unverfiedData"  class="easyui-datagrid"  url="pages/T461/loadHonorInfo?param=1"  style="height: auto"  >
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T461/dataExport?param=1&&excelName=<%=URLEncoder.encode("表4-6-1教师所获荣誉-教学名师.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 		
