...
<body style="height: 100%'" >
	<table  id="unverfiedData"  class="easyui-datagrid"  url="pages/T461/loadHonorInfo?param=2"  style="height: auto"  >
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T461/dataExport?param=2&&excelName=<%=URLEncoder.encode("表4-6-2教师所获荣誉-师德先进个人或研究与创作奖.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 		
	...
	<div id="dlg" class="easyui-dialog"
		...
		buttons="#dlg-buttons">
		<h3 class="ftitle" id="title1">教师荣誉情况模板导入</h3>
