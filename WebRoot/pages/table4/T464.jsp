...
<body style="height: 100%'"  onload="myMarquee('T464','<%=request.getAttribute("CHECKTYPE") %>')">
  <div  id="floatDiv">
  ...
  <br/> 
	<table  id="unverfiedData"  class="easyui-datagrid"  url="pages/T461/loadHonorInfo?checkNum=<%=request.getAttribute("NOCHECK") %>&param=4"  style="height: auto"  >
	...
	<div id="toolbar" style="height:auto">
		<div style="float: left;">
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newObject('4')">添加</a>
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="edit('4')">编辑</a> 
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="deleteByIds('4')">删除</a>
		</div>
	...
	<table id="verfiedData"  class="easyui-datagrid"  url="pages/T461/loadHonorInfo?checkNum=<%=request.getAttribute("PASS") %>&param=4" style="height: auto;" >
		<thead data-options="frozen:true">
			<tr>			
				<th data-options="field:'ck',checkbox:true">选取</th>
				<th  data-options="field:'seqNumber'" >编号</th>
	...
	<div id="toolbar2" style="float: right;">
			<form action='pages/T461/dataExport?param=4&excelName=<%=URLEncoder.encode("表4-6-4教师所获荣誉-优秀教师（党院办）","UTF-8")%>'   method="post"  id="exportForm" enctype="multipart/form-data"  style="float: right;">
