...
<body style="height: 100%'" >
	<table  id="unverfiedData"  class="easyui-datagrid"  url="pages/T461/loadHonorInfo?param=5"  style="height: auto"  >
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T461/dataExport?param=5&&excelName=<%=URLEncoder.encode("表4-6-5教师所获荣誉-教学活动月获奖.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 		
	...
	<div id="dlg" class="easyui-dialog"
		...
		<div class="fitem" id="item1">
		  <form method="post"  id="batchForm" enctype="multipart/form-data">
				...
				<a href='pages/T461/downloadModel?saveFile=<%=URLEncoder.encode("表4-6-5教师所获荣誉-教学活动月获奖.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download">模板下载</a>
			</form>
		</div>	
