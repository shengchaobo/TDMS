...
<body style="height: 100%'" >
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T461/dataExport?param=6&&excelName=<%=URLEncoder.encode("表4-6-6教师所获荣誉-其他.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 		
	...
	<div id="dlg" class="easyui-dialog"
		...
		<div class="fitem" id="item1">
		  <form method="post"  id="batchForm" enctype="multipart/form-data">
				...
				<a href='pages/T461/downloadModel?saveFile=<%=URLEncoder.encode("表4-6-6教师所获荣誉-其他.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download">模板下载</a>
			</form>
		</div>	
				...
				<td>
					<div class="fitem">
						...
						<input class='easyui-combobox' id="awardType" name="T461_bean.awardType" 
							data-options="valueField:'indexId',textField:'awardType',url:'pages/DiAwardType/loadDiAwardType?type=6',listHeight:'auto',editable:false" panelHeight="auto">
