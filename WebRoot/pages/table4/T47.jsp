...
<body style="height: 100%'" >
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T47/dataExport?excelName=<%=URLEncoder.encode("表4-7教学单位所获荣誉（教学单位-校数据采集工作组）","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 		
