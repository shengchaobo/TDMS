...
<body style="height: 100%'" >
	<table  id="unverfiedData"  class="easyui-datagrid"  url="pages/T47/loadHonorInfo"  style="height: auto"  >
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T47/dataExport?excelName=<%=URLEncoder.encode("表4-7教学单位所获荣誉.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 		
	...
	<div id="dlg" class="easyui-dialog"
		...
		buttons="#dlg-buttons">
		<h3 class="ftitle" id="title1">教学单位所获荣誉情况模板导入</h3>
	   ...
	   <h3 class="ftitle">教学单位所获荣誉情况逐条导入</h3>
			...
			--><tr>
				<td colspan="3">
					...
					<div class="fitem">
						...
						<input id="unitId" type="text" name="T47_bean.unitId" class='easyui-combobox' 
