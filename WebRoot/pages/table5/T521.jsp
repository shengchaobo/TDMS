...
<body style="height: 100%'" >
	<table  id="unverfiedData"  class="easyui-datagrid"  url="pages/T521/loadMajorTea"  style="height: auto"  >
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T521/dataExport?excelName=<%=URLEncoder.encode("表5-2-1课程建设情况（教务处）.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 
