...
<meta http-equiv="description" content="This is my page">
	...
	<script type="text/javascript" src="js/table6/S616.js"></script>
	...
	<table id="showData"  style="height: auto">	
		...
		<thead>
			<tr>
				...
				<th data-options="field:'interLevel',align:'center'" colspan="5">
			     2.授予学位数（人）
				</th>
				<th data-options="field:'nationLevel',align:'center'" colspan="5">
				3.招生数（人）
				</th>
				<th data-options="field:'proviLevel',align:'center'" colspan="5">
			     	4.在校生数（人）
				</th>
			</tr>
			<tr>
