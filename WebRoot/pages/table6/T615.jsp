...
<body>
	<table id="commomData" title="普通本科分专业（大类）学生数" class="easyui-datagrid" url="pages/T615/loadData" style="height: auto;">
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T615/dataExport?excelName=<%=URLEncoder.encode("表6-1-5普通本科分专业（大类）学生数（教务处）.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 
	...
	<div id="dlg" class="easyui-dialog"
		...
		buttons="#dlg-buttons">
		<div class="ftitle" id="title1">普通本科分专业（大类）学生数批量导入</div>
		...
		<div></div>
		<div class="ftitle">普通本科分专业（大类）学生数逐条导入</div>
