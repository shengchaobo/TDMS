...
<body>
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T615/dataExport?excelName=<%=URLEncoder.encode("表6-1-5普通本科分专业（大类）学生数（教务处）.xls","ISO-8859-1")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 
