...
<body>
	<table id="commomData" title="待审核数据域审核未通过数据" class="easyui-datagrid" url="pages/T617/loadData" style="height: auto;">
	...
	<div id="dlg" class="easyui-dialog"
		...
		buttons="#dlg-buttons">
		<h3 class="title1">专科在校生信息批量导入</h3>
		...
		<hr></hr>
		<div></div>
		<h3 class="title1">专科在校生信息逐条导入</h3>
