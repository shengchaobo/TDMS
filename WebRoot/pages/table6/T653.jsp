...
<body>
	<table id="commomData" title="学习成果—学生发表作品情况" class="easyui-datagrid" url="pages/T653/loadData" style="height: auto;">
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T653/dataExport?excelName=<%=URLEncoder.encode("表6-5-3学习成果—学生发表作品（教学单位-团委）.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 
	...
	<div id="dlg" class="easyui-dialog"
		...
		buttons="#dlg-buttons">
		<div class="ftitle" id="title1">学生发表作品情况批量导入</div>
		...
		<div></div>
		<div class="ftitle">学生发表作品情况逐条导入</div>
