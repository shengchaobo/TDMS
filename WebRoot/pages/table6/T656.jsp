...
<body>
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T656/dataExport?excelName=<%=URLEncoder.encode("表6-5-5学习成果—英语四六级、计算机等级考试","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 
