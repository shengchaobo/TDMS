...
<body>
	...
	<div id="toolbar2" style="float: right;">
		<a href='pages/T658/dataExport?excelName=<%=URLEncoder.encode("表6-5-8学习成果—参加国际会议（教学单位-国际交流与合作处）","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download" plain="true" >数据导出</a> 
