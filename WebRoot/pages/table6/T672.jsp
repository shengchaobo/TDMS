...
<body style="height: 100%'"  onload="myMarquee('T672','<%=request.getAttribute("CHECKTYPE") %>')">
  <div  id="floatDiv">
  ...
  <br/> 
	...
	url="pages/T672/loadData?checkNum=<%=request.getAttribute("NOCHECK") %>"  style="height: auto;">
	...
	<form action='pages/T672/dataExport?excelName=<%=URLEncoder.encode("表6-7-2双学位情况汇总表（教务处）","UTF-8")%>'   method="post"  id="exportForm" enctype="multipart/form-data"  style="float: right;">
	...
	<div id="dlg" class="easyui-dialog"
		...
		<div class="fitem" id="item1">
			<form id="batchForm" method="post" enctype="multipart/form-data">
				...
				<a href='pages/T672/downloadModel?saveFile=<%=URLEncoder.encode("表6-7-2双学位情况汇总表（教务处）.xls","UTF-8")%>'  class="easyui-linkbutton" iconCls="icon-download">模板下载</a>
			</form>
		</div>
		<hr></hr>	
		<div></div>
		<h3 class="title1">双学位情况逐条导入</h3>
