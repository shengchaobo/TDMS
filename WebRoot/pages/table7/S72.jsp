...
<meta http-equiv="description" content="This is my page">
	...
	<script type="text/javascript" src="jquery-easyui/dialog_bug.js"></script>
	<script type="text/javascript" src="js/table7/S72.js"></script>
...
<body style="overflow-y:scroll">
	<table id="showData"  style="height: auto">
			...
			<tr>
				<th data-options="field:'sumTeaResItem'">
				总数
				</th>
				<th data-options="field:'interItem'">
			          国际级
				</th>
				<th data-options="field:'nationItem'">
				国家级
				</th>
				<th data-options="field:'proviItem'">
				省部级
				</th>
				<th data-options="field:'cityItem'">
				市级
				</th>
				<th data-options="field:'schItem'">
				校级
				</th>
