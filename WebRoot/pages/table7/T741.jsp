...
<body style="overflow-y:scroll">
	<table id="unverfiedData" title="待审核数据域审核未通过数据" class="easyui-datagrid" style="width:100%px;height:250px" url="pages/TeachAbilityAssessAC/auditingData"
		...
		<table>
			...
			<tr>
				...
				<td>
					<div class="fitem">
						<label>评估年份：</label> 
						<input id="AssessYear" type="text" name="teachAbilityAssessAC.AssessYear"
	...
	<script type="text/javascript">
	    ...
	    function newCourse(){
	        url="pages/TeachAbilityAssessAC/insert";
		...
		function editCourse(){
	    	...
	    	url = 'pages/TeachAbilityAssessAC/edit' ;
       ...
       function deleteCourses(ids){
	    	$.ajax({ 
	    		type: "POST", 
	    		url: "pages/TeachAbilityAssessAC/deleteByIds?ids=" + ids, 
	    		async:"true",
	    		dataType: "text",
	    		success: function(result){
	    			result = eval("(" + result + ")");
