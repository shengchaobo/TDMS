...
<html>
  <head>
    ...
    <title>My JSP 'T741_TeachAbilityAssess_AC.jsp' starting page</title>
...
<body style="height: 100%"   onload="myMarquee('T741','<%=request.getAttribute("CHECKTYPE")%>')">
   <div  id="floatDiv">
  ...
  <br/>
	...
	url="pages/T741/auditingData?checkNum=<%=request.getAttribute("NOCHECK")%>"
	...
	<form action='pages/T741/dataExport?excelName=<%=URLEncoder.encode("表7-4-1教师教学能力合格评估","UTF-8")%>'   method="post"  id="exportForm" enctype="multipart/form-data"  style="float: right;">
	...
	url="pages/T741/auditingData?checkNum=<%=request.getAttribute("PASS")%>"
	...
	style="width:800px;height:500px;padding:10px 20px;" closed="true" data-options="modal:true"
		...
		<div class="fitem" id="item1">
			...
			<select class="easyui-combobox"  id="cbYearContrast" name="selectYear"></select>
				...
				<a href="pages/T741/downloadModel?saveFile=<%=URLEncoder.encode("表7-4-1教师教学能力合格评估.xls","UTF-8")%>"  class="easyui-linkbutton" iconCls="icon-download">模板下载</a>
			</form>
			<a href="123"></a>
		</div>
	    <hr></hr>	
		...
		<table>
			...
			<tr>
				<td>
					<div class="fitem">
						<label>教工号：</label> 
						<input id="seqNumber" name="teachAbilityAssessAC.SeqNumber" type="hidden" value="0">
						<input id="Time" name="teachAbilityAssessAC.Time" type="hidden" value="0">
						<input id="TeaID" type="hidden" name="teachAbilityAssessAC.TeaID" >
					    <input id="TeaName" type="text" name="teachAbilityAssessAC.TeaName"
				...
				<td>
					<div class="fitem">
						<label>所属教学单位：</label> 
						<input id="TeaUnit" type="hidden" name="teachAbilityAssessAC.TeaUnit" >
					    <input id="UnitID" type="text" name="teachAbilityAssessAC.UnitID"
			...
			<tr>
				<td>
					<div class="fitem">
						<label>参评课程：</label> 
						<input id="AssessCS" type="text" name="teachAbilityAssessAC.AssessCS"
				...
				<td>
					<div class="fitem">
						<label>课程编号：</label> 
						<input id="CSID" type="text" name="teachAbilityAssessAC.CSID"
			...
			<tr>
				<td>
					<div class="fitem">
						<label>课程类别：</label> 
						<input class='easyui-combobox' id="CSType" name="teachAbilityAssessAC.CSType" 
			...
			<td>
					<div class="fitem">
						<label>评估结果：</label> 
						<select class='easyui-combobox' id="AccessResult" name="teachAbilityAssessAC.AccessResult" panelHeight="auto" editable="false">
			...
			<td class="empty"></td>	
				<td>
					<div class="fitem">
						<label>批文号：</label> 
						<input id="AppvlID" type="text" name="teachAbilityAssessAC.AppvlID"
	...
	var currentYear = new Date().getFullYear();
	 ...
	 function batchImport(){
       ...
       function deleteCourses(ids){
	    	$.ajax({ 
	    		type: "POST", 
	    		url: "pages/T741/deleteByIds?ids=" + ids, 
	    		async:"true",
	    		dataType: "text",
	    		success: function(result){
	    			result = eval("(" + result + ")");
