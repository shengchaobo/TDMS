...
<body style="height: 100%"   onload="myMarquee('T743','<%=request.getAttribute("CHECKTYPE")%>')">
   <div  id="floatDiv">
  ...
  <br/>
	...
	url="pages/T743/auditingData?checkNum=<%=request.getAttribute("NOCHECK")%>"
	...
	<form action='pages/T743/dataExport?excelName=<%=URLEncoder.encode("表7-4-3课程建设评估","UTF-8")%>'   method="post"  id="exportForm" enctype="multipart/form-data"  style="float: right;">
	...
	url="pages/T743/auditingData?checkNum=<%=request.getAttribute("PASS")%>"
	 ...
	 function batchImport(){
	    ...
	    function newCourse(){
	     $('.title1').show();
		    ...
		    $('#dlg').dialog('open').dialog('setTitle','添加课程建设评估情况');
   ...
   function singleImport(){
		...
		function validate(){
	    	...
	    	$('#dlg').dialog('open').dialog('setTitle','修改课程建设评估情况');
