...
<body style="height: 100%"   onload="myMarquee('T744','<%=request.getAttribute("CHECKTYPE")%>')">
   <div  id="floatDiv">
  ...
  <br/>
	...
	url="pages/T744/auditingData?checkNum=<%=request.getAttribute("NOCHECK")%>"
	...
	<form action='pages/T744/dataExport?excelName=<%=URLEncoder.encode("表7-4-4专业建设评估","UTF-8")%>'   method="post"  id="exportForm" enctype="multipart/form-data"  style="float: right;">
	...
	url="pages/T744/auditingData?checkNum=<%=request.getAttribute("PASS")%>"
