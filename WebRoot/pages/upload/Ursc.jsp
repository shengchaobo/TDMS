...
.fitem label {
	...
	<body style="overflow-y: scroll"  onload="loadAllURL(101,101)">
				...
				<tr>				
					<td colspan=2 style="width: 200px; background-color: white"
      				...
      				<td style="background-color: white">
					    <div>
					    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="upload(101)">上传文件</a>
						</div>						
					</td>		      							
					<td style="background-color: white">
						<div id="downFile101"></div>						
					</td>
				</tr>
