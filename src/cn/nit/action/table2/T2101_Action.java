...
public class T2101_Action {
	
	private T2101_Service T2101_services = new T2101_Service();
	
	private T2101_Bean T2101_bean = new T2101_Bean();	
	...
	public void save(){
		...
		T2101_Bean bean  = ToBeanUtil.toBean(tempData, T2101_Bean.class);
										
		boolean flag = T2101_services.save(bean,this.getSelectYear(),this.getFields());
		PrintWriter out = null ;
	...
	public void updateCheck(){
		...
		boolean flag = T2101_services.updateCheck(this.getSelectYear(),this.getCheckNum());
		PrintWriter out = null ;
...
//		}
	...
	public T2101_Bean getT2101_bean() {
		return T2101_bean;
	}

	public void setT2101_bean(T2101_Bean T2101Bean) {
		T2101_bean = T2101Bean;
	}
