...
public class T2103_Action {
	
	private T2103_Service T2103_services = new T2103_Service();
	
	private T2103_Bean T2103_bean = new T2103_Bean();	
	...
	public void save(){
		...
		T2103_Bean bean  = ToBeanUtil.toBean(tempData, T2103_Bean.class);
										
		boolean flag = T2103_services.save(bean,this.getSelectYear(),this.getFields());
		PrintWriter out = null ;
	...
	public void updateCheck(){
		...
		boolean flag = T2103_services.updateCheck(this.getSelectYear(),this.getCheckNum());
		PrintWriter out = null ;
	...
	public T2103_Bean getT2103_bean() {
		return T2103_bean;
	}

	public void setT2103_bean(T2103_Bean T2103Bean) {
		T2103_bean = T2103Bean;
	}
