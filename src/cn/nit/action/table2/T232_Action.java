...
public class T232_Action {
	
	private T232_Service T232_services = new T232_Service();
	
	private T232_Bean T232_bean = new T232_Bean();	
	...
	public void save(){
		...
		T232_Bean bean  = ToBeanUtil.toBean(tempData, T232_Bean.class);
										
		boolean flag = T232_services.save(bean,this.getSelectYear(),this.getFields());
		PrintWriter out = null ;
	...
	public void updateCheck(){
		...
		boolean flag = T232_services.updateCheck(this.getSelectYear(),this.getCheckNum());
		PrintWriter out = null ;
...
//		}
	...
	public T232_Bean getT232_bean() {
		return T232_bean;
	}

	public void setT232_bean(T232_Bean T232Bean) {
		T232_bean = T232Bean;
	}
