...
public class T284_Action {
	
	private T284_Service T284_services = new T284_Service();
	
	private T284_Bean T284_bean = new T284_Bean();	
	...
	public void save(){
		...
		T284_Bean bean  = ToBeanUtil.toBean(tempData, T284_Bean.class);
										
		boolean flag = T284_services.save(bean,this.getSelectYear(),this.getFields());
		PrintWriter out = null ;
	...
	public void updateCheck(){
		...
		boolean flag = T284_services.updateCheck(this.getSelectYear(),this.getCheckNum());
		PrintWriter out = null ;
	...
	public InputStream getInputStream() throws Exception{
		...
		if(bean==null){
		    ...
		    try {    
		           ...
		           ws.addCell(new Label(1, 3, "1.档案", wcf)); 
		           ws.addCell(new Label(2, 3, "2.其他", wcf)); 		         
	...
	public T284_Bean getT284_bean() {
		return T284_bean;
	}

	public void setT284_bean(T284_Bean T284Bean) {
		T284_bean = T284Bean;
	}
