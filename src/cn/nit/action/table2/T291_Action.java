...
public class T291_Action {
	
	private T291_Service T291_services = new T291_Service();
	
	private T291_Bean T291_bean = new T291_Bean();	
	...
	public void save(){
		...
		T291_Bean bean  = ToBeanUtil.toBean(tempData, T291_Bean.class);
										
		boolean flag = T291_services.save(bean,this.getSelectYear(),this.getFields());
		PrintWriter out = null ;
	...
	public void updateCheck(){
		...
		boolean flag = T291_services.updateCheck(this.getSelectYear(),this.getCheckNum());
		PrintWriter out = null ;
...
//		}
	...
	public T291_Bean getT291_bean() {
		return T291_bean;
	}

	public void setT291_bean(T291_Bean T291Bean) {
		T291_bean = T291Bean;
	}
