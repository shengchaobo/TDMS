 ...
 */
public class DiCourseCharDao {

	private String tableName = "DICourseChar" ;
	
	private String field = "IndexID,CourseChar" ;
	
	public List<DiCourseCharBean> getList(){
		
		List<DiCourseCharBean> list = null ;
		...
		try{
			...
			list = DAOUtil.getList(rs, DiCourseCharBean.class) ;
		}catch(Exception e){
			e.printStackTrace() ;
			return list ;
		}finally{
