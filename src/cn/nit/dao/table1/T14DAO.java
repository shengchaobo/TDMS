...
public class T14DAO {
	 ...
	 * @return
	 */
	public List<T14POJO> auditingData(String conditions, String fillUnitId, int page, int rows){
		
		StringBuffer sql = new StringBuffer() ;
		List<T14POJO> list = null ;
...
//		sql.append(" order by SeqNumber desc") ;
		...
		try{
			...
			list = DAOUtil.getList(rs, T14POJO.class) ;
...
//		System.out.println(sql.toString());
	 ...
	 */
	public boolean batchInsert(List<T14_Bean> list){
