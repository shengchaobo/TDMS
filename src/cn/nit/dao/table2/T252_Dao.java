...
public class T252_Dao {
	...
	private String field = "ExpCenterName,TeaUnit,TeaUnitID,LabName,ExpClassHour,StuNum,ExpHour,ExpTimes,PractiseItemNum,Time,Note,FillUnitID";
	 ...
	 */
	public List<T252_Bean> totalList(){
	...
	public boolean batchInsert(List<T252_Bean> list){
		...
		String tempfield = "ExpCenterName,TeaUnit,TeaUnitID,LabName,ExpClassHour,StuNum,ExpHour,ExpTimes,PractiseItemNum,Time,FillUnitID";
		try{
	...
	public boolean update(T252_Bean bean){
		...
		Connection conn = DBConnection.instance.getConnection() ;
		try{
			String updatefield = "ExpCenterName,TeaUnit,TeaUnitID,LabName,ExpClassHour,StuNum,ExpHour,ExpTimes,PractiseItemNum,Note";			
