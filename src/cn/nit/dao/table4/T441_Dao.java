...
public class T441_Dao {
	
	private String tableName = "T441_MajLeader_TeaTea$" ;
	private String field = "FromTeaUnit,TeaUnitID,MajorName,MajorId,MajorLeaderName,TeaId,Time,Note,FillUnitID";
	 ...
	 */
	public List<T441_Bean> totalList(String fillUnitID){
		...
		try{
			...
			list = DAOUtil.getList(rs, T441_Bean.class) ;
		}catch(Exception e){
			e.printStackTrace() ;
			return null ;
		}finally{
	 ...
	 * 
	 */
	public List<T441_Bean> queryPageList(String conditions, String fillunitID, int pageSize, int showPage){
		...
		"FromTeaUnit,TeaUnitID,MajorId,MajorName,TeaId,MajorLeaderName,Time,Note,FillUnitID"
		+ " from " + tableName + 
	 ...
	 */
	public boolean insert(T441_Bean majorLeader){
		
		Connection conn = DBConnection.instance.getConnection() ;
		return DAOUtil.insert(majorLeader, tableName, field, conn) ;
	}
	...
	public boolean batchInsert(List<T441_Bean> list){
		...
		String tempfield = "FromTeaUnit,TeaUnitID,MajorId,MajorName,TeaId,MajorLeaderName,Time,FillUnitID";
		try{
	...
	public boolean update(T441_Bean bean){
		...
		Connection conn = DBConnection.instance.getConnection() ;
		try{
			String updatefield = "FromTeaUnit,TeaUnitID,MajorId,MajorName,TeaId,MajorLeaderName,Note";
