...
public class T441_Dao {
	...
	private String field = "FromTeaUnit,TeaUnitID,MajorName,MajorId,MajorLeaderName,TeaId,Time,Note,FillUnitID,CheckState";
	...
	public List<T441_Bean> queryPageList(String conditions, String fillunitID, int pageSize, int showPage){
		...
		"FromTeaUnit,TeaUnitID,MajorId,MajorName,TeaId,MajorLeaderName,Time,Note,FillUnitID,CheckState"
		+ " from " + tableName + 
	...
	public boolean batchInsert(List<T441_Bean> list){
		...
		String tempfield = "FromTeaUnit,TeaUnitID,MajorId,MajorName,TeaId,MajorLeaderName,Time,FillUnitID,CheckState";
		try{
	...
	public boolean update(T441_Bean bean){
		...
		Connection conn = DBConnection.instance.getConnection() ;
		try{
			String updatefield = "FromTeaUnit,TeaUnitID,MajorId,MajorName,TeaId,MajorLeaderName,Note,CheckState";
