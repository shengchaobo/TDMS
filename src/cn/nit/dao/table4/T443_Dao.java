...
public class T443_Dao {
	
	private String tableName = "T443_HighLevelTalent_Per$" ;
	private String tableName2 = "DiTalentType" ;
	private String field = "Name,TeaId,Type,ResField,GainTime,Time,Note,CheckState";
	...
	public List<T443_Bean> totalList(String year, int checkState){
		...
		String sql = "select " + " SeqNumber,Name,TeaId,TalentType AS Type,ResField,GainTime,Time,Note,CheckState"
		+ " from " + tableName +
	 ...
	 * 
	 */
	public List<T443_Bean> queryPageList(String conditions, String fillunitID, int pageSize, int showPage){
		...
		"Name,TeaId,TalentType AS Type,ResField,GainTime,Time,Note,CheckState"
		+ " from " + tableName + 
		" left join " + tableName2+ " on " + "Type=" + tableName2 + ".IndexID " +
	 ...
	 */
	public boolean insert(T443_Bean highman){
		
		Connection conn = DBConnection.instance.getConnection() ;
		return DAOUtil.insert(highman, tableName, field, conn) ;
	}
	...
	public boolean batchInsert(List<T443_Bean> list){
		...
		String tempfield = "Name,TeaId,Type,ResField,GainTime,Note,Time,CheckState";
		try{
	...
	public boolean update(T443_Bean bean){
		...
		try{
			...
			String updatefield = "Name,TeaId,Type,ResField,GainTime,Note,CheckState";			
