...
public class T444_Dao {
	...
	private String field = "ResField,Type,GainTime,Leader,TeaId,OtherTeamNum,OtherTeamPer,Time,Note,CheckState";
	...
	public boolean batchInsert(List<T444_Bean> list){
		...
		String tempfield = "ResField,Type,GainTime,Leader,TeaId,OtherTeamNum,OtherTeamPer,Time,CheckState";
		try{
	...
	public boolean update(T444_Bean bean){
		...
		Connection conn = DBConnection.instance.getConnection() ;
		try{
			String updatefield = "ResField,Type,GainTime,Leader,TeaId,OtherTeamNum,OtherTeamPer,Note,CheckState";	
