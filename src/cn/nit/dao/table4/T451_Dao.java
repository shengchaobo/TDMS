...
public class T451_Dao {
	 ...
	 */
	public List<T451_Bean> totalList(){
	...
	public boolean batchInsert(List<T451_Bean> list){
		...
		String tempfield = "OrgName,UnitId,OrgType,TrainTimes,TrainPerTimes,Time";
		try{
	...
	public boolean update(T451_Bean bean){
		...
		Connection conn = DBConnection.instance.getConnection() ;
		try{
			String updatefield = "OrgName,UnitId,OrgType,TrainTimes,TrainPerTimes,Note";
