...
public class T451_Dao {
	...
	private String field = "OrgName,UnitId,OrgType,TrainTimes,TrainPerTimes,Time,Note,CheckState";
	 ...
	 * 
	 */
	public List<T451_Bean> queryPageList(String conditions, String fillunitID, int pageSize, int showPage){
	...
	public boolean batchInsert(List<T451_Bean> list){
		...
		String tempfield = "OrgName,UnitId,OrgType,TrainTimes,TrainPerTimes,Time,CheckState";
		try{
	...
	public boolean update(T451_Bean bean){
		...
		Connection conn = DBConnection.instance.getConnection() ;
		try{
			String updatefield = "OrgName,UnitId,OrgType,TrainTimes,TrainPerTimes,Note,CheckState";	
