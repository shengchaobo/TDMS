...
public class T452_Dao {
	...
	private String field = "TeaUnitName,UnitId,Name,TeaId,TrainType,BeginTime,EndTime,InOrOut,TrainUnit,TrainMajor,Time,Note,FillUnitID,CheckState";
	...
	public boolean update(T452_Bean bean){
		...
		try{
			...
			String updatefield = "TeaUnitName,UnitId,Name,TeaId,TrainType,BeginTime,EndTime,InOrOut,TrainUnit,TrainMajor,Note,CheckState";
