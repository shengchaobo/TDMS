...
public class T453_Dao {
	...
	private String field = "TeaUnitName,UnitId,Name,TeaId,CommunType,BeginTime,EndTime,InOrOut,CommunUnit,CommunContent,Time,Note,FillUnitID";
	 ...
	 */
	public List<T453_Bean> totalList(String fillUnitID){
	 ...
	 * 
	 */
	public List<T453_Bean> queryPageList(String conditions, String fillunitID, int pageSize, int showPage){
	...
	public boolean update(T453_Bean bean){
		...
		try{
			...
			String updatefield = "TeaUnitName,UnitId,Name,TeaId,CommunType,BeginTime,EndTime,InOrOut,CommunUnit,CommunContent,Note";
