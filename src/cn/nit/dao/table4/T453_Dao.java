...
public class T453_Dao {
	...
	private String field = "TeaUnitName,UnitId,Name,TeaId,CommunType,BeginTime,EndTime,InOrOut,CommunUnit,CommunContent,Time,Note,FillUnitID,CheckState";
	...
	public boolean update(T453_Bean bean){
		...
		try{
			...
			String updatefield = "TeaUnitName,UnitId,Name,TeaId,CommunType,BeginTime,EndTime,InOrOut,CommunUnit,CommunContent,Note,CheckState";
