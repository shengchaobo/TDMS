...
public class T48_Dao {
	...
	private String field = "TeaUnit,UnitId,TeamName,TeamLevel,Leader,TeaId,GroupNum,GroupInfo,GainTime,AppvlId,Time,Note,FillUnitID";
	 ...
	 */
	public List<T48_Bean> totalList(String fillUnitID){
	 ...
	 * 
	 */
	public List<T48_Bean> queryPageList(String conditions, String fillunitID, int pageSize, int showPage){
	...
	public boolean update(T48_Bean bean){
		...
		Connection conn = DBConnection.instance.getConnection() ;
		try{
			String updatefield = "TeaUnit,UnitId,TeamName,TeamLevel,Leader,TeaId,GroupNum,GroupInfo,GainTime,AppvlId,Note";
			
			String temp1 = updatefield;
			
			if(bean.getTeamLevel().trim().equals("")){
				String a = "TeamLevel,";
