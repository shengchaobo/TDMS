...
public class T48_Dao {
	...
	private String field = "TeaUnit,UnitId,TeamName,TeamLevel,Leader,TeaId,GroupNum,GroupInfo,GainTime,AppvlId,Time,Note,FillUnitID,CheckState";
	...
	public boolean update(T48_Bean bean){
		...
		Connection conn = DBConnection.instance.getConnection() ;
		try{
			String updatefield = "TeaUnit,UnitId,TeamName,TeamLevel,Leader,TeaId,GroupNum,GroupInfo,GainTime,AppvlId,Note,CheckState";
