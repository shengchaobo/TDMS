...
public class T611_Dao {
	 ...
	 * @time: 2014-6-12
	 */
	public boolean insert(T611_Bean UnderGraStuNuminfo) {

		// flag判断数据是否插入成功
		boolean flag = false;
		Connection conn = DBConnection.instance.getConnection();
		try {
			flag = DAOUtil.insert(UnderGraStuNuminfo, tableName, field, conn);
		} catch (Exception e) {
			e.printStackTrace();
			return flag;
		} finally {
	...
	// 更新
	public boolean update(T611_Bean UnderGraStuNuminfo) {

		boolean flag = false;
		Connection conn = DBConnection.instance.getConnection();
		try {
			flag = DAOUtil
					.update(UnderGraStuNuminfo, tableName, key, field, conn);
		} catch (Exception e) {
			e.printStackTrace();
			return flag;
		} finally {
	...
	public List<T611_Bean> queryPageList(int pagesize, int currentpage) {
	...
	public List<T611_Bean> queryPageList(String cond, Object object,
	...
	public List<T611_Bean> getAllList() {
		// TODO Auto-generated method stub
	...
	public List<T611_Bean> getAllList(String cond, Object object) {
		// TODO Auto-generated method stub
		String sql;
