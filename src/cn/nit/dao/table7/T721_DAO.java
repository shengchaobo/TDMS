...
public class T721_DAO {
	...
	public List<T721POJO> auditingData(String conditions,String fillUnitId,int page,int rows){
		...
		sql.append("select t.SeqNumber,t.ItemName,t.TeaUnit,t.UnitID,t.Leader,t.TeaID,t.OtherTeaNum," +
				"t.OtherTea,adl.AwardLevel as ItemLevel,t.ItemLevel as ItemLevelID," +
				"t.ItemSetUpTime,t.ReceptTime,t.ApplvExp,t.SchSupportExp,t.AppvlID,t.Time,t.Note,t.CheckState");
		sql.append(" from "+ tableName +" as t, DiAwardLevel adl");
		sql.append(" where adl.IndexID=t.ItemLevel ");
	 ...
	 */
	public List<T721POJO> totalList(String year,int CheckState){
		
     StringBuffer sql=new StringBuffer();
		
		sql.append("select t.SeqNumber,t.ItemName,t.TeaUnit,t.UnitID,t.Leader," +
				"t.TeaID,t.OtherTeaNum,t.OtherTea,adl.AwardLevel as ItemLevel," +
				"t.ItemLevel as ItemLevelID,t.ItemSetUpTime,t.ReceptTime," +
				"t.ApplvExp,t.SchSupportExp,t.AppvlID,t.Time,t.Note,t.CheckState");
		sql.append(" from "+ tableName +" as t, DiAwardLevel adl");
		sql.append(" where adl.IndexID=t.ItemLevel ");
