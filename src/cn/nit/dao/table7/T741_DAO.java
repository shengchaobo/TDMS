	...
	public boolean insert(T741_Bean teachability){
	 ...
	 /**
		...
		public List<T741POJO> auditingData(String conditions,String fillUnitId,int page,int rows){
			...
			StringBuffer sql=new StringBuffer();		
			sql.append("select  t.SeqNumber,t.TeaName,t.TeaID,t.TeaUnit," +
					"t.UnitID,t.AssessCS,t.CSID,cst.CourseCategories as CSType," +
					"t.CSType as CSTypeID,t.AssessYear,t.AccessResult,t.AppvlID,t.Time,t.Note,t.CheckState");
			sql.append(" from "+ tableName +" as t, DiCourseCategories cst");
		    sql.append(" where cst.IndexID=t.CSType") ;
		 ...
		 */
		public List<T741POJO> totalList(String year,int checkState){
			StringBuffer sql=new StringBuffer();		
			sql.append("select  t.SeqNumber,t.TeaName,t.TeaID,t.TeaUnit," +
					"t.UnitID,t.AssessCS,t.CSID,cst.CourseCategories as CSType," +
					"t.CSType as CSTypeID,t.AssessYear,t.AccessResult,t.AppvlID,t.Time,t.Note,t.CheckState");
