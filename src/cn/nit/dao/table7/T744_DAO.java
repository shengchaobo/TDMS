...
public class T744_DAO {
	...
	public List<T744POJO> auditingData(String conditions,String fillUnitId,int page,int rows){
		...
		sql.append("select  t.SeqNumber,t.TeaUnit,t.UnitID,t.MajorName," +
				"mt.MajorNum as MajorID,t.MajorID as MajorIDD,t.DegreeType," +
				"t.LeaderName,t.TeaID,t.SetYear,t.AssessYear," +
				"t.AssessResult,t.AppvlID,t.Time,t.Note,t.CheckState");
		sql.append(" from "+ tableName +" as t, DiMajorTwo mt");
		sql.append(" where mt.MajorNum=t.MajorID") ;
	 ...
	 */
	public List<T744POJO> totalList(String year,int CheckState){
        StringBuffer sql=new StringBuffer();
		
		sql.append("select  t.SeqNumber,t.TeaUnit,t.UnitID," +
				"t.MajorName,mt.MajorNum as MajorID,t.MajorID as MajorIDD," +
				"t.DegreeType,t.LeaderName,t.TeaID,t.SetYear," +
	 ...
	 /**
		 ...
		 */
		public boolean batchInsert(List<T744_Bean> list){
