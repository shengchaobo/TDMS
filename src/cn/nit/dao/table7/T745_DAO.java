...
public class T745_DAO {
	...
	private String field="TeaUnit,UnitID,AssessYear,AssessResult,AppvlID," +
	...
	public List<T745POJO> auditingData(String conditions,String fillUnitId,int page,int rows){
		...
		sql.append("select  t.SeqNumber,t.TeaUnit," +
				"dbt.UnitID as UnitID,t.UnitID as UnitIDD," +
	...
	public List<T745POJO> totalList(String year,int checkState){
		StringBuffer sql=new StringBuffer();	
		sql.append("select  t.SeqNumber,t.TeaUnit,dbt.UnitID as UnitID," +
				"t.UnitID as UnitIDD,t.AssessYear,t.AssessResult," +
	 ...
	 /**
		...
		public boolean batchInsert(List<T745_Bean> list){
			...
			String tempfield = "TeaUnit,UnitID,AssessYear,AssessResult,AppvlID,Time,Note,FillUnitID,CheckState";
			try{
