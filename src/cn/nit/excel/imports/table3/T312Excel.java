...
public class T312Excel {
		...
		for(Cell[] cell : cellList){
			...
			if(n==0){continue;}
			  ...
			  try{
				...
				t312_Bean.setCooperInsLevel(CooperInsLevel);
				t312_Bean.setCooperInsName(CooperInsName);
				t312_Bean.setCooperInsType(CooperInsType);
				t312_Bean.setFillDept(FillDept);
				t312_Bean.setNote(note);
				t312_Bean.setSignedTime(signedTime);
				t312_Bean.setTime(new Date());
				t312_Bean.setUnitID(UnitID);
				t312_Bean.setUnitLevel(UnitLevel);
	 ...
	 * @throws Exception 
	 */
	public static ByteArrayOutputStream batchExport(List<T312_Bean> list, String sheetName, Map<String,Integer> maplist, List<String> columns) throws Exception{
