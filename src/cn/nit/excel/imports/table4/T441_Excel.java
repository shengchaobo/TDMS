...
public class T441_Excel {
	...
	public String batchInsert(List<Cell[]> cellList, HttpServletRequest request, String selectYear){
		...
		int count = 1 ;
		T441_Bean T441_bean = null ;
		boolean flag = false ;
		List<T441_Bean> list = new LinkedList<T441_Bean>() ;
		...
		flag = false ;
		T441_Service T441_services = new T441_Service() ;
		flag = T441_services.batchInsert(list) ;
