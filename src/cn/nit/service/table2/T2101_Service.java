...
import cn.nit.dao.table2.T2101_Dao;


public class T2101_Service {
	
	private T2101_Dao infoDao = new T2101_Dao();
	
	//根据年参数取得相应年数据
	
	public T2101_Bean getYearInfo(String selectYear){
				
		T2101_Bean bean = infoDao.getYearInfo(selectYear);
