...
public class T744_Service {
	...
	public boolean batchInsert(List<T744_Bean> list){
		return t744_DAO.batchInsert(list);
	...
	public int getCheckState(int seqNumber){
		return t744_DAO.getCheckState(seqNumber) ;
	}
	...
	public boolean updateCheck(int seqNum, int checkState){
		return t744_DAO.updateCheck(seqNum,checkState) ;
	}
	...
	public List<T744POJO> totalList(String year,int CheckState){
		return t744_DAO.totalList(year, CheckState);
	}
	/**
	 * 生成查条件
	 * @param seqNum
